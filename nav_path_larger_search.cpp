...
class MavrosGuider {
    ...
    public:
        MavrosGuider() :
            ...
            // WALL SEARCH //
            msg_pose_out_.pose.position.x = -1.8; // bottom left (1)
            msg_pose_out_.pose.position.y = 1.8;
            temp_rotation.z = M_PI/2;
            msg_pose_out_.pose.orientation = toQuaternion(temp_rotation);
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = -1.2; // (2)
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = -0.6; // 3
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = 0.0; // 4
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = 0.6; // 5
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = 1.2; // 6
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = 1.8; // 7
            pos_target.push_back(msg_pose_out_.pose);
            ...
            msg_pose_out_.pose.position.y = 1.2; // 8
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = 0.6; // 21
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = 0.0; // 22
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = -0.6; // 35
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = -1.2; // 36
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = -1.8; // 49
            pos_target.push_back(msg_pose_out_.pose);
            ...
            msg_pose_out_.pose.position.x = 1.2; // 48
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = 0.6; // 47
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = 0.0; // 46
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = -0.6; // 45
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = -1.2; // 44
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.x = -1.8; // 43
            pos_target.push_back(msg_pose_out_.pose);
            ...
            msg_pose_out_.pose.position.y = -1.2; // 42
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = -0.6; // 29
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = 0.0; // 28
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = 0.6; // 15
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = 1.2; // 14
            pos_target.push_back(msg_pose_out_.pose);

            msg_pose_out_.pose.position.y = 1.8; // 1
            pos_target.push_back(msg_pose_out_.pose);
            ...
            msg_pose_out_.pose.position.y = 0.8; // 8
            pos_target.push_back(msg_pose_out_.pose);
            ...
            msg_pose_out_.pose.position.x = 1.2; //10
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 0.6; //11
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 0.0; //12
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = -0.6; //13
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = -1.2; //14
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = -1.8; //15
            pos_target.push_back(msg_pose_out_.pose); 
            ...
            msg_pose_out_.pose.position.y = 0.2; //16
            pos_target.push_back(msg_pose_out_.pose);  
            ...
            msg_pose_out_.pose.position.x = -1.2; //18
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = -0.6; //19
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 0.0; //20
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 0.6; //21
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 1.2; //22
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 1.8; //23
            pos_target.push_back(msg_pose_out_.pose); 
            ...
            msg_pose_out_.pose.position.y = -0.2; //24
            pos_target.push_back(msg_pose_out_.pose);  
            ...
            msg_pose_out_.pose.position.x = 1.2; //26
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 0.6; //27
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = 0.0; //28
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = -0.6; //29
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = -1.2; //30
            pos_target.push_back(msg_pose_out_.pose); 

            msg_pose_out_.pose.position.x = -1.8; //31
            pos_target.push_back(msg_pose_out_.pose); 
            ...
            msg_pose_out_.pose.position.y = -0.8;
            pos_target.push_back(msg_pose_out_.pose);
            ...
            msg_pose_out_.pose.position.x = -0.6;
            pos_target.push_back(msg_pose_out_.pose); 
            ...
            msg_pose_out_.pose.position.x = 1.8;
            pos_target.push_back(msg_pose_out_.pose); 
